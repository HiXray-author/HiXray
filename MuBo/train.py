...
parser.add_argument('--dataset', default='HiXray', choices=['VOC', 'COCO','HiXray'],
                    type=str, help='VOC or COCO or HiXray')
parser.add_argument('--dataset_root', default=HiXray_ROOT,
...
parser.add_argument('--transfer', default='/mnt/ssd300_mAP_77.43_v2.pth', type=str,
...
parser.add_argument('--save_folder', default='/mnt/submit_to_github/CVPR/weights/',type=str,
                    help='Directory for saving checkpoint models')
parser.add_argument('--image_sets', default='/mnt/cvpr_dataset/train/train_name.txt',type=str,
                    help='Directory for saving checkpoint models')
...
#args.save_folder += 'submit_to_github/' + 'xmb_rgb_r_score_attention_adapt_sigmoid_rgb_red-rgb_position-gated_conv_hou/'
...
def train():
    if args.dataset == 'COCO':
        ...
        dataset = HiXrayDetection(root=args.dataset_root, image_sets=args.image_sets,phase='train')
